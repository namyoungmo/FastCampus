...
resource "aws_subnet" "test-public-subnet-eks-pods-a" {
  ...
  tags = {
    Name                                     = "test-public-subnet-eks-pods-a"
    "kubernetes.io/cluster/test-eks-cluster" = "shared"
    "kubernetes.io/role/elb"                 = 1
  }
...
resource "aws_subnet" "test-public-subnet-eks-pods-c" {
  ...
  tags = {
    Name                                     = "test-public-subnet-eks-pods-c"
    "kubernetes.io/cluster/test-eks-cluster" = "shared"
    "kubernetes.io/role/elb"                 = 1
  }
